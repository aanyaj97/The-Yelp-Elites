...
'''
    Uses MapReduce to create JSON file with dictionary mapping review ID to a list of the words in that review.
    Example output from Champaign dataset is in review_text_dict.json
'''
